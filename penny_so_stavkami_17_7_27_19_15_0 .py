...
class MyFrame(wx.Frame):
   ...
   def proverka_ubranu_li_Stavki(self):
       ...
       time.sleep(0.01)
       pustoy = wx.Image('stavka0.bmp', type=wx.BITMAP_TYPE_ANY)  # произошла ошибка
       p2 = pustoy.GetData()
       # print("зашли в цикл")
       time.sleep(0.01)
       if p1 == p2:
...
########################################### блок решения
                   ...
                   if  razresheno and to_game:
                       ...
                       #     break
                   if (old_key == 0):
                       if (old_key == 0) and (key1 == 26):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         0,26 \n')
                           file_obj_win.close()
                       else:
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('0,'+ str(key1)+'\n')
                           file_obj_win.close()
                   elif (old_key == 7):
                       if (old_key == 7) and (key1 == 2):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         7,2 ')
                           file_obj_win.close()
                       else:
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('7,' + str(key1) + '\n')
                           file_obj_win.close()
                   elif (old_key == 15):
                       if (old_key == 15) and (key1 == 11):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         15,11 \n')
                           file_obj_win.close()
                       else:
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('15,' + str(key1) + '\n')
                           file_obj_win.close()
                   elif (old_key == 17):
                       if (old_key == 17) and (key1 == 13):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         17,13 \n')
                           file_obj_win.close()
                       elif (old_key == 17) and (key1 == 7):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         17,7 \n')
                           file_obj_win.close()
                       else:
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('17,' + str(key1) + '\n')
                           file_obj_win.close()
                   elif (old_key == 19):
                       if (old_key == 19) and (key1 == 14):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         19,14 \n')
                           file_obj_win.close()
                       else:
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('19,' + str(key1) + '\n')
                           file_obj_win.close()
                   elif (old_key == 27):
                       if (old_key == 27) and (key1 == 15):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         27,15 \n')
                           file_obj_win.close()
                       else:
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('27,' + str(key1) + '\n')
                           file_obj_win.close()
                   elif (old_key == 35):
                       if (old_key == 35) and (key1 == 24):
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('         35,24 \n')
                           file_obj_win.close()
                       else:
                           file_obj_win = open('log_wining.txt', 'a')
                           file_obj_win.write('35,' + str(key1) + '\n')
                           file_obj_win.close()
                   old_key = key1
